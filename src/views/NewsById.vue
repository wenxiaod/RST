  ...
  <div id="bewsbyid">
    ...
    <div class="view-box">
      ...
      <div class="positewr wrapper">
        <span>当前位置：</span><a href="./#/">首页 ></a><a href="./#/news">新闻动态 ></a><a href="./#/news">企业新闻 ></a><a class="on"
          href="javascript:;">正文</a>
      </div>
      <iframe class="iframe " :src="newsbyid.visitPath" frameborder="0" id="test"></iframe>
